...
open class PieChartView: PieRadarChartViewBase
{
    ...
    ///
    /// **default**: `0.5`
    private var _holeRadiusPercent = CGFloat(0.8) //"Modify---"
    
    private var _transparentCircleColor: NSUIColor? = NSUIColor(white: 1.0, alpha: 105.0/255.0)
    
    /// the radius of the transparent circle next to the chart-hole in the center
    private var _transparentCircleRadiusPercent = CGFloat(0.0)//0.55 "Modify---"
        ...
        set
        {
            ...
            else
            {
                ...
                attrString?.setAttributes([
                    ...
                    .font: NSUIFont.systemFont(ofSize: 20.0),
